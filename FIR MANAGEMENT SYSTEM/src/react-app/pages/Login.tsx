        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 p-4">
            <Card className="w-full max-w-md shadow-lg border-blue-100">
                <CardHeader className="space-y-1 text-center pb-6">
                    ...
                    <CardTitle className="text-3xl font-bold tracking-tight text-slate-900">CrimeTrack Pro</CardTitle>
                    <CardDescription className="text-base mt-2">Sign in to the Officer Dashboard</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 h-12 text-base transition-colors">
                            Sign In
                        </Button>
                    </form>
                </CardContent>
